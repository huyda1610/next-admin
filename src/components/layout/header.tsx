          ...
          <div className="order-2 lg:order-none">
            <Popover>
              <PopoverTrigger asChild>
                <button type="button" className="relative duration-300 hover:opacity-80">
                ...
                <div className="max-h-64 divide-y divide-gray-300 overflow-y-auto">
                  {!notifications?.length ? (
                    ...
                    notifications.map((notification) => (
                      ...
                      >
                        <Link href="#" className="size-9 shrink-0 overflow-hidden rounded-lg">
                          <Image
                            alt="Profile"
                            width={36}
                            height={36}
              ...
              <DropdownMenuTrigger asChild>
                <div className="group flex cursor-pointer items-center gap-2.5 rounded-lg [&[data-state=open]>button>svg]:rotate-180">
                  ...
                  <div className="hidden space-y-1 lg:block">
                    ...
                    <h2 className="line-clamp-1 text-xs font-bold text-black">Jackson James</h2>
                  </div>
                  <button
                    type="button"

...
const checkboxVariants = cva(
    ...
    ' focus-visible:outline-none transition disabled:cursor-not-allowed disabled:opacity-40 ',
  {
    variants: {
      ...
      color: {
        default: 'data-[state=checked]:border-black data-[state=checked]:bg-black',
        primary: 'data-[state=checked]:border-primary data-[state=checked]:bg-primary',
        success: 'data-[state=checked]:border-success data-[state=checked]:bg-success',
        pending: 'data-[state=checked]:border-warning data-[state=checked]:bg-warning',
        danger: 'data-[state=checked]:border-danger data-[state=checked]:bg-danger',
        outlineBlack: 'data-[state=checked]:border-black data-[state=checked]:!text-black',
        outlinePrimary: 'data-[state=checked]:border-primary data-[state=checked]:!text-primary',
        outlineSuccess: 'data-[state=checked]:border-success data-[state=checked]:!text-success',
        outlinePending: 'data-[state=checked]:border-warning data-[state=checked]:!text-warning',
        outlineDanger: 'data-[state=checked]:border-danger data-[state=checked]:!text-danger',
      },
    },
    defaultVariants: {
      variant: 'default',
